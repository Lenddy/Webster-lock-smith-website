...
export const products = [
	...
	},
	{
		...
		links: [
			{ title: "Gardall", link: "", img: [{ src: blankkeys, alt: "image-4" }] },
			{ title: "Perma-Vault", link: "", img: [{ src: blankkeys, alt: "image-5" }] },
			{ title: "Amsec", link: "", img: [{ src: blankkeys, alt: "image-7" }] },
		],
	},
	{
		...
		links: [
			{ title: "Baldwin", link: "", img: [{ src: blankkeys, alt: "image-8" }] },
			{ title: "Emtek", link: "", img: [{ src: blankkeys, alt: "image-9" }] },
			{ title: "Omnia", link: "", img: [{ src: blankkeys, alt: "image-10" }] },
		],
	},
	{
		name: "Hardware",
		...
		links: [
			{ title: "", link: "", img: [{ src: blankkeys, alt: "image-12" }] },
			{ title: "", link: "", img: [{ src: blankkeys, alt: "image-13" }] },
			{ title: "", link: "", img: [{ src: blankkeys, alt: "image-14" }] },
		],
	},

	{
		...
		links: [
			{ title: "", link: "", img: [{ src: blankkeys, alt: "image-15" }] },
			{ title: "", link: "", img: [{ src: blankkeys, alt: "image-16" }] },
			{ title: "", link: "", img: [{ src: blankkeys, alt: "image-17" }] },
		],
	},
];
...
export const services = [
	{
		...
		description: " Webster Locksmiths is also the key to the security needs for your car. \n Automotive locks come in many forms and we work all of them: \n Factory and after-market remote control and transmitter replacements \nDoor locks \n Glove compartment locks \n Fuel tank locks \n Trunk Lock \n Luggage rack locks \n Ignition, shift,and steering wheel locks \nWe also install custom car alarms of all makes and models. In short, we stock and install any security system you might need for your car. \n Need a copy of your computer chip-enabled car key? Check out our Automotive Transponder Keys page for more info on how to save a trip to your dealer and some money. \n You can expect the same multi-faceted approach we are known for throughout the tri-state area when it comes to your car. ",
		links: [
			{ title: "", link: "", img: [{ src: blankkeys, alt: "image-18" }] },
			{ title: "", link: "", img: [{ src: blankkeys, alt: "image-19" }] },
			{ title: "", link: "", img: [{ src: blankkeys, alt: "image-20" }] },
		],
	},
	{
		name: "Automotive Transponder Keys",
		description: "Do you need a spare key for your car? \n Computer chips embedded in the plastic head of most keys prevent your car from being stolen, but they also make it hard to have a spare made. \n If you lose your key, this can be an especially difficult problem to solve, especially if the engine computer module has to be replaced. Who wouldn’t want to avoid a costly, inconvenient trip to the dealer? \n Come to Webster Locksmiths, the key to all your security needs.\n We specialize in Automotive Transponder Keys. Our state-of-the-art facility and computer programming equipment can duplicate these keys for less time and cost than a dealer. No job is too tough for us.We can do it all, including replacing that engine computer module.",

		links: [
			{ title: "", link: "", img: [{ src: blankkeys, alt: "image-21" }] },
			{ title: "", link: "", img: [{ src: blankkeys, alt: "image22" }] },
			{ title: "", link: "", img: [{ src: blankkeys, alt: "image23" }] },
		],
	},
	{
		...
		links: [
			{ title: "Iron Doors", link: "", img: [{ src: blankkeys, alt: "image23" }] },
			{ title: "Hollow Metal Doors", link: "", img: [{ src: blankkeys, alt: "image24" }] },
			{ title: "Kalamein Doors (Apartment & commercial)", link: "", img: [{ src: blankkeys, alt: "image25" }] },
			{ title: "Aluminum Doors", link: "", img: [{ src: blankkeys, alt: "image26" }] },
			{ title: "Glass Herculite Doors", link: "", img: [{ src: blankkeys, alt: "image27" }] },
			{ title: "Gates", link: "", img: [{ src: blankkeys, alt: "image28" }] },
		],
	},
	{
		...
		links: [
			{ title: "Window Gates", link: "", img: [{ src: blankkeys, alt: "image29" }] },
			{ title: "Building Entrances", link: "", img: [{ src: blankkeys, alt: "image30" }] },
			{ title: "Doors", link: "", img: [{ src: blankkeys, alt: "image31" }] },
			{ title: "Gates", link: "", img: [{ src: blankkeys, alt: "image32" }] },
			{ title: "Fire Escape Gates", link: "", img: [{ src: blankkeys, alt: "image33" }] },
			{ title: "Oranmental Iron Works", link: "", img: [{ src: blankkeys, alt: "image34" }] },
			{ title: "Railings", link: "", img: [{ src: blankkeys, alt: "image35" }] },
			{ title: "Railings", link: "", img: [{ src: blankkeys, alt: "image36" }] },
			{ title: "Tree Guards", link: "", img: [{ src: blankkeys, alt: "image37" }] },
		],
	},

	{
		...
		links: [
			{ title: "", link: "", img: [{ src: blankkeys, alt: "image38" }] },
			{ title: "", link: "", img: [{ src: blankkeys, alt: "image39" }] },
			{ title: "", link: "", img: [{ src: blankkeys, alt: "image40" }] },
		],
	},
];
